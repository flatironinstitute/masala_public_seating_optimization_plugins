...
/// @file src/seating_optimization/seating_problem_elements/constraints/GuestOverlapConstraint.hh
/// @brief Headers for a GuestOverlapConstraint.
...
#ifndef Seating_Optimization_Masala_Plugins_src_seating_optimization_seating_problem_elements_constraints_GuestOverlapConstraint_hh
#define Seating_Optimization_Masala_Plugins_src_seating_optimization_seating_problem_elements_constraints_GuestOverlapConstraint_hh

// Forward declarations:
#include <seating_optimization/seating_problem_elements/constraints/GuestOverlapConstraint.fwd.hh>
...
/// @brief A GuestOverlapConstraint.
/// @details The GuestOverlapConstraint class is used to indicate that two guests cannot be assigned to the same seat.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).
class GuestOverlapConstraint : public seating_optimization_masala_plugins::seating_optimization::seating_problem_elements::constraints::Constraint {
...
////////////////////////////////////////////////////////////////////////////////
	...
	GuestOverlapConstraint() = default;

	/// @brief Copy constructor.  Explicit due to mutex.
	GuestOverlapConstraint( GuestOverlapConstraint const & src );

	/// @brief Destructor.
	~GuestOverlapConstraint() override = default;
...
////////////////////////////////////////////////////////////////////////////////
	...
	/// @brief Constraint strength.  Defaults to 0.  Positive values indicate a penalty for two guests being assigned the same seat;
	/// negative values indicate a bonus.
	masala::base::Real constraint_strength_ = 0.0;

}; // class GuestOverlapConstraint
...
#endif // Seating_Optimization_Masala_Plugins_src_seating_optimization_seating_problem_elements_constraints_GuestOverlapConstraint_hh