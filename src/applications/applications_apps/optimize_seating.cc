...
load_dwave_cfn_optimizer(
...

	{
		...
		set_setter<Real>( tracerman, appname, *abqp_api_def, "set_onenode_penalty_cap", 12.0 );
		set_setter<Real>( tracerman, appname, *abqp_api_def, "set_twonode_penalty_cap", 12.0 );
